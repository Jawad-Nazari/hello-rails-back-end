...
**Hello Rails Backend** is an implemention of a connection between Ruby on Rails back-end and React front-end. [Hello Rails Backend](https://github.com/Jawad-Nazari/Hello-Rails-Back-end) handles the backend API, and [Hello React Frontend](https://github.com/Jawad-Nazari/Hello-React-Front-end) handles the frontend UI to display a random greeting message.
...
Feel free to check the [issues page](https://github.com/Jawad-Nazari/hello-rails-back-end/issues).
